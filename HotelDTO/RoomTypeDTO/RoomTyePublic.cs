...
namespace DangDucThuanFinalYear.HotelDTO.RoomTypeDTO
{
    ...
    public record RoomTyePublicDetalis(short id, string Name, string Image, string Description, decimal Price,int MaxAults, int MaxChildren, RoomTypeAmenityModel[] Amenities);
